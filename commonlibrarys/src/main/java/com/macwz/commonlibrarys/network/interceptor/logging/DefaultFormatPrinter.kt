package com.macwz.commonlibrarys.network.interceptor.logging

import android.text.TextUtils
import android.util.Log
import com.macwz.commonlibrarys.utils.CharacterHandler.Companion.jsonFormat
import com.macwz.commonlibrarys.utils.CharacterHandler.Companion.xmlFormat
import com.macwz.commonlibrarys.utils.ext.jzProject
import com.macwz.commonlibrarys.network.interceptor.logging.LogInterceptor.Companion.isJson
import com.macwz.commonlibrarys.network.interceptor.logging.LogInterceptor.Companion.isXml
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    private object LogUtils{
        fun debugInfo(tag: String?, msg: String?) {
            if (!jzProject || TextUtils.isEmpty(msg)) {
                return
            }
            Log.d(tag, msg!!)
        }
