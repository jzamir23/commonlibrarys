...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) KtxKt.getAppContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static boolean isLandscape() {
        return KtxKt.getAppContext().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) KtxKt.getAppContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static int getSleepDuration() {
        try {
            return Settings.System.getInt(
                    KtxKt.getAppContext().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (KtxKt.getAppContext().getResources().getConfiguration().screenLayout
