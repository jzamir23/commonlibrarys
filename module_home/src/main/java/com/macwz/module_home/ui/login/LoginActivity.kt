...
@Route(path = RoutePath.HOME_LOGIN)
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val info = ComponentServiceUtil.getParameterInfo(RoutePath.MY_SERVICE) as String
...
//                loginViewModel.login(username.text.toString(), password.text.toString())
                ComponentServiceUtil.navigatePage(RoutePath.APP_MAIN,"")
            }
        }
    }
